...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2024 a las 00:19:19
...
--
-- Estructura de tabla para la tabla `tb_stars`
--
...
--
-- Volcado de datos para la tabla `tb_stars`
--

INSERT INTO `tb_stars` (`id`, `Stars`, `Comentario`, `FechaRegistro`) VALUES
(1, 1, 'asdasd', '2024-02-16 12:54:28'),
(2, 5, 'capitan america', '2024-02-16 12:54:52'),
(3, 5, 'Muy rapido y eficiente', '2024-02-16 13:03:50'),
(4, 4, 'SI FUE MUY SATISFACTORIO Y ME AYUDO CON MI PROBLEMA', '2024-02-16 13:11:00'),
(5, 5, 'muy amable el doctor', '2024-02-16 16:57:26'),
(6, 5, 'EL DOCTOR ES MUY AMABLE', '2024-02-16 17:04:12');
...
--
-- AUTO_INCREMENT de la tabla `tb_stars`
--
ALTER TABLE `tb_stars`
